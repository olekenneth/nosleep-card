...
// TODO You need to replace all instances of "action-handler-nosleep" with "action-handler-<your card name>"
customElements.define('action-handler-nosleep', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-nosleep')) {
    return body.querySelector('action-handler-nosleep') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-nosleep');
